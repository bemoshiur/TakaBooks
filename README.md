...
| Compliance calendar — every recurring NBR and RJSC deadline | সম্মতি পঞ্জিকা | `vat.py` reads the VAT and VDS ones; the rest is reference text | ✅ landed | 🟡 27 nodes — 23 verified · 4 unverified |
